...
export const WeaveSpinner = ({ className, size = 24 }: { className?: string; size?: number }) => {
  // Original weave spinner is designed for 160x160.
  // We'll scale it down to the requested size multiplied by 3 as requested.
  const finalSize = size * 3;
  const scale = finalSize / 160;
  ...
  const css = `
          ...
          .node {
            ...
            animation: nodePulse 6.4s cubic-bezier(0.68, -0.55, 0.27, 1.55) infinite;
          }
          ...
          .t1 {
            ...
            top: 30%;
            left: 0;
            animation: weave1 8s cubic-bezier(0.45, 0, 0.55, 1) infinite;
          }
          ...
          .t2 {
            ...
            top: 0;
            left: 70%;
            animation: weave2 8.8s cubic-bezier(0.68, -0.55, 0.27, 1.55) infinite;
          }
          ...
          .t3 {
            ...
            bottom: 30%;
            left: 0;
            animation: weave3 9.6s cubic-bezier(0.23, 1, 0.32, 1) infinite;
          }
          ...
          .t4 {
            ...
            top: 0;
            left: 30%;
            animation: weave4 10.4s cubic-bezier(0.36, 0, 0.66, -0.56) infinite;
          }
  ...
  return (
    <>
      ...
      >
        <div className="spinner-container" style={{ transform: `scale(${scale})`, transformOrigin: 'center' }}>
