    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground overflow-hidden">
        <div className="relative z-20">
          <div className="flex items-center gap-2 text-lg font-semibold">
            ...
            <span>Innovizia Leave Planner</span>
          </div>
        </div>
      ...
      <div className="relative flex items-center justify-center p-8 bg-background">
        ...
        <button
          ...
          className="absolute top-6 right-6 p-2 rounded-full bg-secondary/50 hover:bg-secondary text-foreground transition-colors border border-border shadow-sm"
        >
        ...
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="admin@innovizia.com"
                value={email}
                autoComplete="off"
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="/forgot-password" onClick={(e) => { e.preventDefault(); router.push('/forgot-password'); }} className="text-sm text-primary hover:underline font-medium">
                Forgot password?
              </a>
            </div>
          ...
          <div className="text-center text-sm text-muted-foreground mt-8">
            ...
            <a href="/contact-admin" onClick={(e) => { e.preventDefault(); router.push('/contact-admin'); }} className="text-foreground font-medium hover:underline">Contact Admin</a>
          </div>
        </div>
      </div>
    </div>
